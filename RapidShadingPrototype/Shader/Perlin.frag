...
void main( void )
{
  ...
  //float n = snoise(v_texCoord2D * 8.0);
  //float n = noise(vec3(2.0 * v_texCoord3D.xyz * (2.0 + sin(0.5 * time))));
  //float n = snoise(vec3(2.0 * v_texCoord3D.xyz * (2.0 + sin(0.5 * time))));
  //float n = noise(vec4(8.0 * v_texCoord3D.xyz, 0.5 * time));
  float t = 0.5 * time;
  float n = snoise(vec4(2.0 * v_texCoord3D.xyz, t)) + 
            snoise(vec4(4.0 * v_texCoord3D.xyz, t)) * 0.5 + 
            snoise(vec4(8.0 * v_texCoord3D.xyz, t)) * 0.25
        ;

  //float n = noise(vec3(2.0 * v_texCoord3D.xyz * (2.0 + sin(0.5 * time))));
  /*float n = snoise(v_texCoord3D.xyz) + 
  			snoise(2.0 * v_texCoord3D.xyz) * 0.5 +
  			snoise(4.0 * v_texCoord3D.xyz) * 0.25 +
  			snoise(8.0 * v_texCoord3D.xyz) * 0.125 +
  			snoise(16.0 * v_texCoord3D.xyz) * 0.0625
  			;*/
  /*float n = noise(v_texCoord3D.xyz) + 
  			noise(2.0 * v_texCoord3D.xyz) * 0.5 +
  			noise(4.0 * v_texCoord3D.xyz) * 0.25 +
  			noise(8.0 * v_texCoord3D.xyz) * 0.125 +
  			noise(16.0 * v_texCoord3D.xyz) * 0.0625
  			;*/
