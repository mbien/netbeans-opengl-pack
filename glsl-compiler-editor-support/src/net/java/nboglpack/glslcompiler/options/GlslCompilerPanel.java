...
final class GlslCompilerPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        optionsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_OptionsPanelTitle"))); // NOI18N

        patternLabel.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_ErrorParserPatternLabel")); // NOI18N
        ...
        optionsPanelLayout.setHorizontalGroup(
            ...
            .add(optionsPanelLayout.createSequentialGroup()
                ...
                .add(patternTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        runtimePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_RuntimePanelTitle"))); // NOI18N

        glVersion.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_OpenGLVersionLabel")); // NOI18N

        glVersionLabel.setText("jLabel2");

        gpuVendor.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_GPU_VendorLabel")); // NOI18N

        vendorLabel.setText("jLabel4");

        joglVersion.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_JOGL_VersionLabel")); // NOI18N

        joglVersionLabel.setText("jLabel6");

        jLabel1.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_VertexShaderLabel")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_FragmentShaderLabel")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(GlslCompilerPanel.class, "GlslCompilerPanel_GeometryShaderLabel")); // NOI18N
