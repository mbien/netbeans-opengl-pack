...
public class Gears implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    private void setupShader(GL gl) {
        try {
            simpleFragmentShader = new FragmentShader(gl, new FileReader("C:\\Users\\Samuel Sperling\\ProceduralTexturing\\Shader\\experimental.fs.glsl"));
            simpleVertexShader = new VertexShader(gl, new FileReader("C:\\Users\\Samuel Sperling\\ProceduralTexturing\\Shader\\basic.vs.glsl"));
  ...
  public void display(GLAutoDrawable drawable) {
    ...
    GL gl = drawable.getGL();
    simpleVertexShader.apply();
    simpleFragmentShader.apply();
